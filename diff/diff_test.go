...
func TestDiff(t *testing.T) {
	...
	tests := []runner{
		testDiffCase[int]{name: "int not equal", lhs: 1, rhs: 2, want: &diff.Result{Lhs: int(1), Rhs: int(2), Kind: diff.Different}},
		testDiffCase[int]{name: "int equal", lhs: 1, rhs: 1, want: nil},
		testDiffCase[myInt]{name: "myInt not equal", lhs: 1, rhs: 2, want: &diff.Result{Lhs: myInt(1), Rhs: myInt(2), Kind: diff.Different}},
		testDiffCase[myInt]{name: "myInt equal", lhs: 1, rhs: 1, want: nil},
		testDiffCase[getter]{name: "getter not equal", lhs: myInt(1), rhs: myInt(2), want: &diff.Result{Lhs: myInt(1), Rhs: myInt(2), Kind: diff.Different}},
		...
		testDiffCase[getter]{name: "getter one nil", lhs: nil, rhs: myInt(1), want: &diff.Result{Lhs: nil, Rhs: myInt(1), Kind: diff.Different}},
		testDiffCase[getter]{name: "getter different underlying types", lhs: myInt(1), rhs: myString("a"), want: &diff.Result{Lhs: myInt(1), Rhs: myString("a"), Kind: diff.Different}},
		testDiffCase[ptrGetter]{name: "ptrGetter not equal", lhs: ptr(myInt(1)), rhs: ptr(myInt(2)), want: &diff.Result{Lhs: myInt(1), Rhs: myInt(2), Kind: diff.Different}},
		testDiffCase[ptrGetter]{name: "ptrGetter equal", lhs: ptr(myInt(1)), rhs: ptr(myInt(1)), want: nil},
		testDiffCase[ptrGetter]{name: "ptrGetter nil", lhs: nil, rhs: nil, want: nil},
		testDiffCase[ptrGetter]{name: "ptrGetter one nil", lhs: nil, rhs: ptr(myInt(1)), want: &diff.Result{Lhs: nil, Rhs: ptr(myInt(1)), Kind: diff.Different}},
		...
		testDiffCase[*string]{name: "string ptr not equal", lhs: ptr("a"), rhs: ptr("b"), want: &diff.Result{Lhs: "a", Rhs: "b", Kind: diff.Different}},
		testDiffCase[*string]{name: "string ptr equal", lhs: ptr("a"), rhs: ptr("a"), want: nil},
		testDiffCase[float64]{name: "float64 not equal", lhs: 1.0, rhs: 2.0, want: &diff.Result{Lhs: float64(1.0), Rhs: float64(2.0), Kind: diff.Different}},
		testDiffCase[float64]{name: "float64 equal", lhs: 1.0, rhs: 1.0, want: nil},
		testDiffCase[*float64]{name: "float64 ptr not equal", lhs: ptr(1.0), rhs: ptr(2.0), want: &diff.Result{Lhs: float64(1.0), Rhs: float64(2.0), Kind: diff.Different}},
		testDiffCase[*float64]{name: "float64 ptr equal", lhs: ptr(1.0), rhs: ptr(1.0), want: nil},
		testDiffCase[compStruct]{name: "compStruct not equal", lhs: compStruct{Str: "a", Int: 1}, rhs: compStruct{Str: "b", Int: 2}, want: &diff.Result{Lhs: "a", Rhs: "b", Kind: diff.Different}},
		testDiffCase[compStruct]{name: "compStruct equal", lhs: compStruct{Str: "a", Int: 1}, rhs: compStruct{Str: "a", Int: 1}, want: nil},
		testDiffCase[*compStruct]{name: "compStruct ptr not equal", lhs: ptr(compStruct{Str: "a", Int: 1}), rhs: ptr(compStruct{Str: "b", Int: 2}), want: &diff.Result{Lhs: "a", Rhs: "b", Kind: diff.Different}},
		testDiffCase[*compStruct]{name: "compStruct ptr equal", lhs: ptr(compStruct{Str: "a", Int: 1}), rhs: ptr(compStruct{Str: "a", Int: 1}), want: nil},
		testDiffCase[nonCompStruct]{name: "nonCompStruct not equal", lhs: nonCompStruct{Slice: []int{1, 2}}, rhs: nonCompStruct{Slice: []int{2, 1}}, want: &diff.Result{Lhs: int(1), Rhs: int(2), Kind: diff.Different}},
		testDiffCase[nonCompStruct]{name: "nonCompStruct equal", lhs: nonCompStruct{Slice: []int{1, 2}}, rhs: nonCompStruct{Slice: []int{1, 2}}, want: nil},
		...
		testDiffCase[[]int]{name: "slice not equal", lhs: []int{1, 2}, rhs: []int{2, 1}, want: &diff.Result{Lhs: int(1), Rhs: int(2), Kind: diff.Different}},
		testDiffCase[[]int]{name: "slice equal", lhs: []int{1, 2}, rhs: []int{1, 2}, want: nil},
		testDiffCase[[]int]{name: "slice lhs nil", lhs: nil, rhs: []int{1, 2}, want: &diff.Result{Lhs: nil, Rhs: int(1), Kind: diff.Extra}},
		testDiffCase[[]int]{name: "slice rhs nil", lhs: []int{1, 2}, rhs: nil, want: &diff.Result{Lhs: int(1), Rhs: nil, Kind: diff.Missing}},
		testDiffCase[[]int]{name: "slice extra", lhs: []int{1, 2}, rhs: []int{1, 2, 3}, want: &diff.Result{Rhs: int(3), Kind: diff.Extra}},
		testDiffCase[[]int]{name: "slice missing", lhs: []int{1, 2, 3}, rhs: []int{1, 2}, want: &diff.Result{Lhs: int(3), Kind: diff.Missing}},
		testDiffCase[mySlice]{name: "mySlice not equal", lhs: mySlice{1, 2}, rhs: mySlice{2, 1}, want: &diff.Result{Lhs: int(1), Rhs: int(2), Kind: diff.Different}},
		testDiffCase[mySlice]{name: "mySlice equal", lhs: mySlice{1, 2}, rhs: mySlice{1, 2}, want: nil},
		testDiffCase[mySlice]{name: "mySlice lhs nil", lhs: nil, rhs: mySlice{1, 2}, want: &diff.Result{Lhs: nil, Rhs: int(1), Kind: diff.Extra}},
		testDiffCase[mySlice]{name: "mySlice rhs nil", lhs: mySlice{1, 2}, rhs: nil, want: &diff.Result{Lhs: int(1), Rhs: nil, Kind: diff.Missing}},
